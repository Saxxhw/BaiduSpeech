...
import com.saxxhw.bs.recognization.IRecogListener;
import com.saxxhw.bs.recognization.RecogResult;
...
public abstract class BaiduASRDialog extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkConfig();
        input = BaseApp.Companion.getDigitalDialogInput();
